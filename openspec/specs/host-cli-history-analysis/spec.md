# host-cli-history-analysis Specification

## Purpose

Define explicit, local, privacy-aware analysis of historical host AI CLI sessions from Codex, Claude Code, and OpenCode so those sessions can become searchable Growth Knowledge Hub context.
